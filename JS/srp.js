...
{
	throw new Error("SRP requires ajax.js (webrequest utilities)");	
}
...
*
**/
SRP.Account.prototype.send = function(url, callback)
{
...
/**
*	__FOR INTERNAL USE ONLY__ Calls the callback is present with a message.
*
...
/**
*	__FOR INTERNAL USE ONLY__ Calls callbackError if present
*
